...
struct OpenXRServerConfig: Equatable {
    ...
    # OpenXR OSX Runtime Configuration
    # Preferred location: ~/Library/Application Support/OpenXR-OSX/openxr_osx.toml
    ...
    # Capture Quest/headset logcat to ~/Library/Application Support/OpenXR-OSX/openxr_osx_quest.log.
    # Requires adb in PATH and a connected device.
    quest_logcat = false
    """

    static func parse(from text: String) -> OpenXRServerConfig {
        var config = OpenXRServerConfig()
