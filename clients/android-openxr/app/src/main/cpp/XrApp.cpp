...
#define LOG_TAG "OpenXR-OSX-Client"
...
bool XrApp::CreateInstance(struct android_app* app)
{
    ...
    strncpy(createInfo.applicationInfo.applicationName, "OpenXR OSX Client",
            XR_MAX_APPLICATION_NAME_SIZE);
    createInfo.applicationInfo.applicationVersion = 1;
    createInfo.applicationInfo.apiVersion = XR_API_VERSION_1_0;
    strncpy(createInfo.applicationInfo.engineName, "OpenXR OSX",
